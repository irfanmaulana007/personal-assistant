...
import { getIntegrations, setWebSearchKey, setOpenAIKey, setTrelloCreds } from '../../api/client';
...
function TrelloCredsCard({
  ...
  return (
    ...
    >
      <div className="mb-4 flex items-center justify-between">
        <h2 className="text-base font-semibold text-gray-900 dark:text-gray-50">Trello</h2>
        {configured ? (
          <span className="rounded-full bg-green-100 px-3 py-1 text-xs font-medium text-green-700 dark:bg-green-500/15 dark:text-green-300">
            Configured
          </span>
