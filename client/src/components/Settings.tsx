...
export function Settings() {
  ...
  // Field overrides: null means "use the loaded/saved value" so the inputs
  // stay in sync with server state without copying into state via an effect.
  ...
  // Switching provider prefills the base URL and model from its preset
  // (both remain editable, and "custom" clears them for a manual endpoint).
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="mt-1 text-xs text-gray-400">
                  All providers use an OpenAI-compatible API. Choosing one fills in its default
                  endpoint and model.
                </p>
              </div>
