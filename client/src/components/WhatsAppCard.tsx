...
const badge: Record<string, { label: string; cls: string }> = {
  ...
  pairing: { label: 'Waiting for scan', cls: 'bg-amber-100 text-amber-700' },
    ...
    <div className="mt-6 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-green-100 text-sm font-semibold text-green-700">
            WA
          </div>
          <div>
      ...
      {wa.status === 'pairing' && (
        <div className="mt-4 flex flex-col items-center gap-3 rounded-xl border border-gray-100 bg-gray-50 p-4 text-center">
          {wa.qr ? (
