...
func (s *Server) Start(ctx context.Context) error {
	...
	mux.Handle("POST /api/integrations/trello/workspaces", projectAdmin(s.handleAttachTrelloWorkspace))
	mux.Handle("DELETE /api/integrations/trello/workspaces/{id}", projectAdmin(s.handleDeleteTrelloWorkspace))
	mux.Handle("GET /api/integrations/trello/workspaces/{id}/available-boards", projectAdmin(s.handleTrelloAvailableBoards))
