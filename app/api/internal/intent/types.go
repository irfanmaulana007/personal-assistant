...
// Trello actions (review the boards; file a task or a bug card; update or
// archive an existing card; capture a game idea)
const (
	...
	ActionTrelloArchiveCard Action = "trello.archive_card"
